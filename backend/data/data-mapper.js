...
export async function mapData(data) {
	...
	const customData = mapCustomData(mappedData);
	const allData = {
		...mappedData,
		...customData
	}
...
export function mapCustomData(mappedData) {
	let customData = {};

	customData["Organic Viewers"] = organicViewers.mapOrganicViewersData(mappedData["Average Viewers"], mappedData["Hosts & Raids"]);
	customData["Artificial Viewers"] = artificialViewers.mapArtificialViewersData(mappedData["Average Viewers"], mappedData["Hosts & Raids"]);
	customData["Minutes Per Viewer"] = minutesPerViewer.mapMinutesPerViewerData(mappedData["Minutes Watched"], mappedData["Unique Viewers"]);
	customData["Lurkers"] = lurkers.mapLurkersData(mappedData["Unique Viewers"], mappedData["Chatters"]);
